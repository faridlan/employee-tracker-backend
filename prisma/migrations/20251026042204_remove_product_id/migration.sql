/*
  ...
  - You are about to drop the column `productId` on the `Target` table. All the data in the column will be lost.
...
INSERT INTO "new_Target" ("created_at", "date", "employee_id", "id", "nominal", "product_id", "updated_at") SELECT "created_at", "date", "employee_id", "id", "nominal", "product_id", "updated_at" FROM "Target";
DROP TABLE "Target";
